...
/// Workshop shockwave - 2/3 scale, no outer particles
struct WorkshopShockwave: View {
    let center: CGPoint
    let isActive: Bool
    let color: Color
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            let maxRadius = screenSize * 1.0 // 2/3 of 1.5 = 1.0
    ...
    private func centralEffects(maxRadius: CGFloat) -> some View {
        ZStack {
            ...
            // Inner particles only (no outer particles for workshop)
